...
public class Agendamento {
    ...
    @NotNull(message = "O campo do agendamento não pode ser vazio")
   ...
   @Column(nullable = false)
    ...
    public Agendamento(Long id, Cliente cliente, Prestador prestador, Servico servico, StatusAgendamento statusAgendamento, LocalDate data, LocalDateTime hora, LocalDateTime dataHoraRegistro) {
        this.id = id;
